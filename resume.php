<?php
  ...
  // subject
  $subject = "Submit Resume from iSelectCareers";
  
  // create message
  
  	$message  = '<html><body>';
	$message .=  "<p>This email has been sent using the iSelectCareers submit resume form. </p>";
	...
	$message .= "<tr><td><strong>Cover letter:</strong> </td><td>" . $comment . "</td></tr>";
	$message .= "</table>";
	$message .= "</body></html>";
